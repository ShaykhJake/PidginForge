    ...
    <v-card class="sandstorm mb-2">
      <v-card-title class="sandstone py-1">
        ...
        <v-btn
          ...
          @click="showingQuestion = !showingQuestion"
        >
      ...
      <v-card-text class="desertsand pt-2" v-show="showingQuestion">
        ...
        <div
          :style="
            `${question.stem_rtl ? 'direction: rtl;' : 'direction: ltr;'}`
          "
        >
          <v-textarea
        ...
        <hr />
        <h2>
          Answer Alternatives ({{ question.alternatives.length }}):
          <v-btn
            fabsmall
            class="primary desertsand--text ml-2"
        ...
        <div
          :style="
            `${question.alternatives_rtl ? 'direction:rtl' : 'direction: ltr'}`
          "
        >
          <div v-if="!question.multiple_select">
            ...
            >
              ...
              >
                ...
                <v-card-text
                  :class="
                    alternative_class(question.answer_key, alternative.id)
                  "
                >
                  <v-radio
                    label="Correct"
          ...
          <div v-else>
            ...
            >
              ...
              <v-card-text
                :class="alternative_class(question.answer_key, alternative.id)"
              >
                <v-checkbox
                  dense
                  v-model="question.answer_key"
...
export default {
  ...
  data() {
    return {
      isNewQuestion: false,
      contentTypes: ["Audio", "Video", "Rich Text", "Image"],
