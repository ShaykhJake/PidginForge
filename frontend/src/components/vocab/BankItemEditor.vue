                  ...
                  <v-card class="desertsand">
                     ...
                     <v-card-text>
                        ...
                        <v-autocomplete
                           ...
                           color="primary"
                           :label="`${l1Language} existing words in database (${l1WordList.length})`"
                           item-text="word"
                           item-value="id"
               ...
               <v-col cols="6">
                  <v-card class="desertsand">
                     ...
                     <v-card-text>
                        ...
                        <v-autocomplete
                           v-if="showingPairings && !loadingPairings && !loadingL1Details"
                        ...
                        >
                              ...
                              <template v-slot:item="data">
                                 ...
                                 <template v-else>
                                    <v-list-item-content>
                                       ...
                                       <v-list-item-subtitle>
                                          Paired with your selected word {{ data.item.count }} times...
                                       </v-list-item-subtitle>
                           ...
                           <v-autocomplete
                              ...
                              color="primary"
                              :label="`${l2Language} existing words in database (${l2WordList.length})`"
                              item-text="word"
                              item-value="id"
                        ...
                        <span v-if="showingL2WordList" class="overline">Don't like what you see?</span>
                        <v-btn small v-if="showingL2WordList || noL2Results" block class="languages desertsand--text" @click="newTerm2Dialog=true">Add New Term<v-icon right>mdi-plus-box-outline</v-icon></v-btn>
                     ...
                     <v-card-text>
                        <v-row>
                           <v-col>
                              ...
                              <v-card class="sandstone mb-2" v-if="l1Details.word && !loadingL1Details">
                                 ...
                                 <v-card-text class="sandstone">
                                    ...
                                    # of Grammar Notes: {{ l1Details.grammars.length }}<br>
                                    # of Associated Pairs: {{ l1Details.word_pair_count }}<br>
                           ...
                           <v-col>
                              ...
                              <v-card class="sandstone mb-2" v-if="showingL2Details && l2Details.word && !loadingL2Details">
                              <v-card-title class="sandstone py-1">
                                 Target
                              </v-card-title>
                              <v-card-text class="sandstone">
                                 ...
                                 # of Definitions: {{ l2Details.definitions.length }}<br>
                                 # of Sentences: {{ l2Details.definitions.length }}<br>
                                 # of Grammar Notes: {{ l2Details.grammars.length }}<br>
                                 # of Associated Pairs: {{ l2Details.word_pair_count }}<br>
