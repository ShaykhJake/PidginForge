<template>
  <v-container>
    <v-card v-if="lexeme.lemma" class="desertsand mb-2">
      <v-card-title
        class="display-1 justify-center desertsand"
        :style="`text-align: center; direction: ${lexeme.direction}`"
      >
        {{ lexeme.lemma }}<br />
      </v-card-title>
    ...
    <v-card class="desertsand mb-2">
      <v-card-text pa-0>
        <LexemeDefinitionsTable :lexemeslug="lexemeslug" />
      </v-card-text>
    </v-card>
    <v-card class="desertsand mb-2">
      <v-card-text pa-0>
        <LexemePronunciationsTable :lexemeslug="lexemeslug" />
      </v-card-text>
    </v-card>
    <v-card class="desertsand mb-2">
      <v-card-text pa-0>
    ...
    Inflected Forms (v-for components) Comments
  </v-container>
</template>
    ...
    wordPairs: [
      {
        ...
        curator: {
          ...
          user_profile: {
            avatar:
              "https://jakesdesk-media.s3.amazonaws.com/media/public/avatars/2020/04/29/auto-mechanic-2829141_1280_wWHTNbf.jpg",
            image:
              "https://jakesdesk-media.s3.amazonaws.com/media/public/profile_pics/2020/04/29/auto-mechanic-2829141_1280_C9M1Lll.jpg"
          }
        },
          ...
          grammars: [
            {
              ...
              curator: {
                ...
                user_profile: {
                  avatar:
                    "https://jakesdesk-media.s3.amazonaws.com/media/public/avatars/2020/04/29/J_logo_EDENL6I.jpg",
                  image:
                    "https://jakesdesk-media.s3.amazonaws.com/media/public/profile_pics/2020/04/29/J_logo_mOg6SmT.jpg"
                }
              },
              curationdate: "May 17, 2020",
              updated: "May 17, 2020",
