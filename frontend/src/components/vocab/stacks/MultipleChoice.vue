  ...
  <v-dialog v-model="dialog" scrollable persistent height=400 max-width=425>
     ...
     <v-card v-if="currentPair != null">
        <v-card-title class="sandstone">
           Multiple Choice: {{ currentPair + 1 }} of {{ pairs.length }}
           <v-spacer></v-spacer>
               ...
               <v-container fill-height fluid>
                  <v-row align="center" justify="center" no-gutters>
                        ...
                        <v-col align="center">
                           ...
                           <div v-if="side == 1">
                              <h1>
                                 {{ randomPairs[currentPair].lexeme_1_details.lemma }} <br>
                              </h1>
                              <div v-if="randomPairs[currentPair].lexeme_1_audio.audio_file">
                                 <audio  controls :src="randomPairs[currentPair].lexeme_1_audio.audio_file">
                                 </audio>
                              </div>
        ...
        <audio v-if="selectedAudio" controls autoplay :src="selectedAudio">
        </audio>
