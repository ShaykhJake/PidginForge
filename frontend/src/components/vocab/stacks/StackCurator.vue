              ...
              <v-dialog v-model="dialog" v-if="dialog" max-width="500px">
                <v-card class="desertsand">
                  ...
                  <v-card-text>
                    <v-container>
                      ...
                      <v-form class="mt-3" dense>
                        <h3 class="mb-2">
                          {{ stack.learning_language }} Lexemes
                        </h3>
                        <v-autocomplete
                          v-model="lexeme1"
                          ...
                          :items="lexeme1List"
                          :label="
                            `${l1Language} Lexemes (${lexeme1List.length})`
                          "
                        ...
                        <h3 class="mb-2">
                          {{ stack.native_language }} Pairings
                        </h3>
                        <v-autocomplete
                          v-model="lexemePair"
                        ...
                        >
                          <template v-slot:item="data">
                            ...
                            <template v-else>
                              <v-list-item-content>
                                <v-list-item-title
                                  v-html="data.item.pairing.lemma"
                                ></v-list-item-title>
                                <v-list-item-subtitle
                                  >Curated by
                                  {{
                                    data.item.pairing.curator.username
                                  }}</v-list-item-subtitle
                                >
                                <v-list-item-subtitle
                                  >{{ data.item.pairing.definitions.length }}
                                  definitions;
                                  {{ data.item.pairing.inflected_forms.length }}
                                  inflections</v-list-item-subtitle
                                >
                              </v-list-item-content>
                            </template>
                          </template>
                        ...
                        <div style="text-align: center;" class="mb-5">
                          ...
                          <v-btn
                            small
                            class="primary"
                            @click="addPairDialog = true"
                            :disabled="lexeme1.length < 1"
                          >
                            Add New Pairing
                          </v-btn>
                        </div>
                  ...
                  <v-card-actions class="sandstone">
                    <v-spacer></v-spacer>
                    <v-btn color="garbage desertsand--text" @click="close"
                      >Cancel</v-btn
                    >
                    <v-btn
                      color="primary"
