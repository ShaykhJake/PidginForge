    ...
    <v-card class="desertsand">
      ...
      <v-card-text class="px-2">
        <p class="overline">
          ...
          word or several words, considered as an abstract unit, and applied to
          a family of words related by form or meaning." In english, to go, he
          goes, and I went all can be grouped with the lexeme "go", which is how
          they are found in a dictionary. Lexeme and lemma are often used
          interchangeably, but lemma is the actual word representation of the
          lexeme.
        </p>
