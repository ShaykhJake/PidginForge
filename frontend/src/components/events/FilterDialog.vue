<template>
  ...
  <v-card class="sandstone calligraphy--text">
    ...
    <v-card-text class="desertsand calligraphy--text px-2">
         ...
         <v-checkbox v-model="filterSettings.byRSVP" label="Filter by RSVP 'Yes'"></v-checkbox>
    ...
    <v-card-actions class="sandstone">
      <v-btn @click="resetFilters" class="garbage desertsand--text">Reset<v-icon right>mdi-refresh</v-icon></v-btn>
      <v-spacer></v-spacer>
      <v-btn @click="submitFilter" class="primary">Close<v-icon right>mdi-filter</v-icon></v-btn>
    </v-card-actions>
  </v-card>
  </v-dialog>
</template>
