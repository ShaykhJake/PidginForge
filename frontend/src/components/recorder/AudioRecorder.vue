<template>
  <div class="desertsand py-3">
    ...
    <div v-if="audioSource === 'microphone'" style="text-align:center;">
      <span class="overline" v-if="!recording && !processing"
