        ...
        <v-col cols="12">
                <v-row justify-center dense wrap>
                  ...
                  <v-col cols="12" sm="6" md="6">
                    <v-card>
                      ...
                      <v-card-text>
                        Stack Name - Language - Mastery (hyperlinked)
                        <v-list three-line>
                          <v-subheader>
                            Show List of Saved Stacks Here with Mastery Percentage for Each
                          </v-subheader>
                        </v-list>
                      </v-card-text>
                    </v-card>
              ...
              <v-row justify-center dense wrap>
                ...
                <v-col cols="12">
                  <v-card class="desertsand">
                    <v-toolbar class="desertsand calligraphy--text" dense elevation="6">
                      <v-toolbar-title>New Lessons</v-toolbar-title>
                      <v-spacer></v-spacer>
                ...
                <v-col cols="12">
                  <v-card>
                    <v-toolbar class="desertsand calligraphy--text" dense>
                      <v-toolbar-title>New Videos</v-toolbar-title>
                      <v-spacer></v-spacer>
                ...
                <v-col cols="12">
                  <v-card>
                    <v-toolbar class="desertsand calligraphy--text" dense>
                      <v-toolbar-title>New Audio</v-toolbar-title>
                      <v-spacer></v-spacer>
                ...
                <v-col cols="12">
                  <v-card outlined>
                    <v-toolbar class="desertsand calligraphy--text" dense>
                      <v-toolbar-title>New Texts</v-toolbar-title>
                      <v-spacer></v-spacer>
                ...
                <v-col cols="12">
                  <v-card>
                    <v-toolbar class="desertsand calligraphy--text" dense>
                      <v-toolbar-title>New Forum Activity</v-toolbar-title>
                      <v-spacer></v-spacer>
